...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiCommandsExportBackup({required String destPath});
  ...
  Future<String> crateApiLifecycleRecoveryPhrase();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiCommandsExportBackup({required String destPath}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiCommandsExportBackupConstMeta,
        argValues: [destPath],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiCommandsExportBackupConstMeta =>
      const TaskConstMeta(debugName: "export_backup", argNames: ["destPath"]);
  ...
  Future<bool> crateApiLifecycleIsFreshInstall() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLifecycleIsFreshInstallConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLifecycleIsFreshInstallConstMeta =>
  ...
  Future<String> crateApiLifecycleRecoveryPhrase() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLifecycleRecoveryPhraseConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLifecycleRecoveryPhraseConstMeta =>
      const TaskConstMeta(debugName: "recovery_phrase", argNames: []);
  ...
  Future<void> crateApiLifecycleRestoreBackup({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiLifecycleRestoreBackupConstMeta,
        argValues: [archivePath, recoveryPhrase],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiLifecycleRestoreBackupConstMeta =>
      const TaskConstMeta(
        debugName: "restore_backup",
        argNames: ["archivePath", "recoveryPhrase"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_CastedPrimitive_u_64(defaultLifetimeSecs, serializer);
  ...
  ConnectionHistoryEntry dco_decode_connection_history_entry(dynamic raw) {
    ...
    return ConnectionHistoryEntry(
      atUnixMs: dco_decode_CastedPrimitive_u_64(arr[0]),
      peerNodeId: dco_decode_opt_String(arr[1]),
      event: dco_decode_String(arr[2]),
      detail: dco_decode_String(arr[3]),
      establishMs: dco_decode_opt_CastedPrimitive_u_64(arr[4]),
    );
  }
  ...
  DiagnosticsSnapshot dco_decode_diagnostics_snapshot(dynamic raw) {
    ...
    return DiagnosticsSnapshot(
      capturedAtUnixMs: dco_decode_CastedPrimitive_u_64(arr[0]),
  ...
  GossipTopicSnapshot dco_decode_gossip_topic_snapshot(dynamic raw) {
    ...
    return GossipTopicSnapshot(
      ...
      peerCount: dco_decode_CastedPrimitive_usize(arr[1]),
    );
  }
  ...
  MediaAttachment dco_decode_media_attachment(dynamic raw) {
    ...
    return MediaAttachment(
      ...
      byteLen: dco_decode_CastedPrimitive_u_64(arr[2]),
      mime: dco_decode_String(arr[3]),
      durationMs: dco_decode_opt_CastedPrimitive_u_64(arr[4]),
      ...
      blobSecret: dco_decode_opt_list_prim_u_8_strict(arr[9]),
    );
  }
  ...
  MediaDraftInput dco_decode_media_draft_input(dynamic raw) {
    ...
    return MediaDraftInput(
      ...
      durationMs: dco_decode_opt_CastedPrimitive_u_64(arr[1]),
  ...
  PeerSnapshot dco_decode_peer_snapshot(dynamic raw) {
    ...
    return PeerSnapshot(
      ...
      lastSeenUnixMs: dco_decode_opt_CastedPrimitive_u_64(arr[3]),
  ...
  ReducedPost dco_decode_reduced_post(dynamic raw) {
    ...
    return ReducedPost(
      ...
      expiresAt: dco_decode_opt_CastedPrimitive_u_64(arr[5]),
      createdAt: dco_decode_CastedPrimitive_u_64(arr[6]),
  ...
  UserProfile dco_decode_user_profile(dynamic raw) {
    ...
    return UserProfile(
      ...
      defaultLifetimeSecs: dco_decode_opt_CastedPrimitive_u_64(arr[5]),
      onboarded: dco_decode_bool(arr[6]),
      createdAt: dco_decode_CastedPrimitive_u_64(arr[7]),
      updatedAt: dco_decode_CastedPrimitive_u_64(arr[8]),
    );
  }
  ...
  WavSummary dco_decode_wav_summary(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return WavSummary(
      durationMs: dco_decode_CastedPrimitive_u_64(arr[0]),
  ...
  ConnectionHistoryEntry sse_decode_connection_history_entry(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_atUnixMs = sse_decode_CastedPrimitive_u_64(deserializer);
    ...
    var var_establishMs = sse_decode_opt_CastedPrimitive_u_64(deserializer);
    return ConnectionHistoryEntry(
  ...
  DiagnosticsSnapshot sse_decode_diagnostics_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_capturedAtUnixMs = sse_decode_CastedPrimitive_u_64(deserializer);
  ...
  GossipTopicSnapshot sse_decode_gossip_topic_snapshot(
    ...
    var var_peerCount = sse_decode_CastedPrimitive_usize(deserializer);
  ...
  MediaAttachment sse_decode_media_attachment(SseDeserializer deserializer) {
    ...
    var var_blobHash = sse_decode_String(deserializer);
    var var_byteLen = sse_decode_CastedPrimitive_u_64(deserializer);
    var var_mime = sse_decode_String(deserializer);
    var var_durationMs = sse_decode_opt_CastedPrimitive_u_64(deserializer);
    ...
    var var_blobSecret = sse_decode_opt_list_prim_u_8_strict(deserializer);
    return MediaAttachment(
      kind: var_kind,
      blobHash: var_blobHash,
      byteLen: var_byteLen,
  ...
  PeerSnapshot sse_decode_peer_snapshot(SseDeserializer deserializer) {
    ...
    var var_lastSeenUnixMs = sse_decode_opt_CastedPrimitive_u_64(deserializer);
  ...
  UserProfile sse_decode_user_profile(SseDeserializer deserializer) {
    ...
    var var_defaultLifetimeSecs = sse_decode_opt_CastedPrimitive_u_64(
      deserializer,
    );
    var var_onboarded = sse_decode_bool(deserializer);
    var var_createdAt = sse_decode_CastedPrimitive_u_64(deserializer);
    var var_updatedAt = sse_decode_CastedPrimitive_u_64(deserializer);
    return UserProfile(
      version: var_version,
      profileId: var_profileId,
      displayName: var_displayName,
  ...
  void sse_encode_connection_history_entry(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_CastedPrimitive_u_64(self.atUnixMs, serializer);
    ...
    sse_encode_opt_CastedPrimitive_u_64(self.establishMs, serializer);
  }
  ...
  void sse_encode_diagnostics_snapshot(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_CastedPrimitive_u_64(self.capturedAtUnixMs, serializer);
  ...
  void sse_encode_gossip_topic_snapshot(
    ...
    sse_encode_CastedPrimitive_usize(self.peerCount, serializer);
  }
  ...
  void sse_encode_media_attachment(
    ...
    sse_encode_CastedPrimitive_u_64(self.byteLen, serializer);
    sse_encode_String(self.mime, serializer);
    sse_encode_opt_CastedPrimitive_u_64(self.durationMs, serializer);
    ...
    sse_encode_opt_list_prim_u_8_strict(self.blobSecret, serializer);
  }
  ...
  void sse_encode_peer_snapshot(PeerSnapshot self, SseSerializer serializer) {
    ...
    sse_encode_opt_CastedPrimitive_u_64(self.lastSeenUnixMs, serializer);
  ...
  void sse_encode_user_profile(UserProfile self, SseSerializer serializer) {
    ...
    sse_encode_opt_CastedPrimitive_u_64(self.defaultLifetimeSecs, serializer);
    sse_encode_bool(self.onboarded, serializer);
    sse_encode_CastedPrimitive_u_64(self.createdAt, serializer);
    sse_encode_CastedPrimitive_u_64(self.updatedAt, serializer);
  }
